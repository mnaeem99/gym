...
@section('content')
    ...
    <section class="blog-details-hero set-bg" data-setbg="resources/assets/img/blog/blog-detail-hero.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="bd-text">
                        ...
                        <div class="bd-pic">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="resources/assets/img/blog/bd-1.jpg" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src="resources/assets/img/blog/bd-2.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blog-author">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="ba-pic">
                                        <img src="resources/assets/img/blog/blog-posted.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <div class="ba-text">
